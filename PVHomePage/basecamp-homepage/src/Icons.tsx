export const CMSInfo: React.FC<{ size?: number, color?: string }> = ({ size = 30, color = "#0D2499" }) => (
    <svg width={size} height={size} viewBox="0 0 50 50">
        <circle cx="25" cy="25" r="25" fill="#CCDCE3"/>
...
export const CMSAlertIcon: React.FC<{ size?: number, color?: string }> = ({ size = 64, color = "#0D2499" }) => (
    <svg width={size} height={size} viewBox={`0 0 64 64`} xmlns="http://www.w3.org/2000/svg">
        <circle cx={32} cy={32} r={32} fill="#CCDCE3" />
...
export const CMSNotifications: React.FC<{ size?: number, color?: string }> = ({ size = 64, color = "#0D2499" }) => (
    ...
    <circle cx="28" cy="28" r="28" fill="#CCDCE3"/>
...
export const CMSHCTADDashBoardIcon: React.FC<{size?: number}> = ({ size = 64}) => (
    ...
    <circle cx="28" cy="28" r="28" fill="#CCDCE3"/>
    <g transform="translate(7,7) scale(1.75)">
        <path d="M6.25 3A3.25 3.25 0 0 0 3 6.25v8.5A3.25 3.25 0 0 0 6.25 18h8.5A3.25 3.25 0 0 0 18 14.75v-8.5A3.25 3.25 0 0 0 14.75 3h-8.5Zm6.5 4.5a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm.75 3.25a1.5 1.5 0 0 1 1.5 1.5v.5c0 .496-.086.86-.254 1.16-.168.303-.43.562-.818.83-.733.503-1.858.76-3.428.76-1.32 0-2.445-.257-3.24-.76-.419-.266-.73-.524-.938-.83-.205-.3-.322-.664-.322-1.16v-.5a1.5 1.5 0 0 1 1.5-1.5h6Z" fill="#01395E"/>
        <path d="M6.01 19a3.248 3.248 0 0 0 2.74 1.5h6.5c2.9 0 5.25-2.35 5.25-5.25v-6.5c0-1.15-.598-2.162-1.5-2.74v9.24A3.75 3.75 0 0 1 15.25 19H6.01Z" fill="#01395E"/>
    </g>
</svg>
)
...
export const CMSAuditingDashboardIcon: React.FC<{ size?: number }> = ({ size = 64 }) => (
    ...
    <g transform="translate(4,4) scale(0.88)">
        <rect x="17" y="14" width="24" height="34" rx="4" stroke="#01395E" strokeWidth="3.8" />
        <rect x="24" y="10" width="10" height="6" rx="3" fill="#CCDCE3" stroke="#01395E" strokeWidth="3.8" />
        <path d="M22 23L24 25L28 21" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M22 30L24 32L28 28" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M22 37L24 39L28 35" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round" />
        <line x1="31" y1="23" x2="36" y2="23" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" />
        <line x1="31" y1="30" x2="36" y2="30" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" />
        <line x1="31" y1="37" x2="34" y2="37" stroke="#01395E" strokeWidth="3.4" strokeLinecap="round" />
        <circle cx="42" cy="40" r="6.5" fill="white" stroke="#01395E" strokeWidth="3.8" />
        <line x1="46.5" y1="44.5" x2="51.5" y2="49.5" stroke="#01395E" strokeWidth="4" strokeLinecap="round" />
    </g>
</svg>
);
