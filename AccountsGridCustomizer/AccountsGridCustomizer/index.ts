...
import { CellCustomRender } from "./customizers/CellCustomRender";

export class AccountsGridCustomizer implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    /**
     * Empty constructor.
     */
    constructor() {
