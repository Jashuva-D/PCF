...
class NoteForm extends React.Component<NoteFormProps, NoteFormState> {
  ...
  onSubmit() {
    ...
    if (this.props.recordid && this.props.recordid !== "") {
      ...
      this.props.context?.webAPI.updateRecord(
        "cr549_applicationnotes",
        this.props.recordid!,
        record
      ).then(function (resp) {
        ...
        if (obj.state.submittoconfluence) {
          ...
          var request = {
            ...
            entity: {
              entityType: "cr549_applicationnotes",
              id: obj.props.recordid!
            },
            ...
            getMetadata: function () {
              ...
              return {
                ...
                parameterTypes: {
                  entity: {
                    typeName: "mscrm.cr549_applicationnotes",
                    structuralProperty: 5
                  }
                },

                operationType: 0,
                operationName: "crm2_PushToConfluencePage"
              };
          ...
          (obj.props.context.webAPI as any).execute(request).then(
            ...
            function success(response: any) {
              ...
              if (response.ok) {
                ...
                obj.props.showalert(
                  CMSAlertType.Success,
                  "Note updated successfully."
                );

                obj.props.submitCallBack &&
                  obj.props.submitCallBack({
                    recordid: obj.props.recordid!,
                    comments: obj.state.comment,
                    topic: obj.state.topic,
                    topicowner: obj.state.topicowner,
                    interactiontype: obj.state.interactiontype
                  });
      ...
      const record = {
        ...
        "regardingobjectid_cr549_application_cr549_applicationnotes@odata.bind":
          `/cr549_applications(${(this.props.context as any).page.entityId})`,
      ...
      this.props.context?.webAPI.createRecord(
        "cr549_applicationnotes",
        record
      ).then(function (resp) {
  ...
  getSubmitToConfluenceToggle(): JSX.Element {
    ...
    return (
      <Toggle
        inlineLabel
        label="Submit to Confluence"
        defaultChecked={this.state.submittoconfluence}
        onChange={() =>
          this.setState({
            submittoconfluence: !this.state.submittoconfluence
          })
        }
      ...
      <>
        ...
        >
          ...
          <StackItem>
            ...
            >
              ...
              <StackItem grow>
                ...
                <Dropdown
                  ...
                  onChange={(evt, option) =>
                    this.setState({
                      interactiontype: option?.key as number
                    })
                  }
                ...
                <StackItem grow>
                  ...
                  <TextField
                    ...
                    errorMessage={
                      this.state.submittoconfluence &&
                      (
                        this.state.confluencepageid == null ||
                        this.state.confluencepageid?.trim() == ""
                      )
              ...
              {this.state.submittoconfluence &&
                ...
                <StackItem grow>
                  ...
                  <TextField
                    ...
                    value={this.state.confluencespace}

                    onChange={(evt, newvalue) => {
                      this.setState({
                        confluencespace: newvalue
                      })
                    }}
              ...
              {this.state.submittoconfluence &&
                ...
                <StackItem grow>
                  ...
                  <TextField
                    ...
                    value={this.state.confluencepagetitle}

                    onChange={(evt, newvalue) => {
                      this.setState({
                        confluencepagetitle: newvalue
                      })
                    }}
            ...
            {this.state.interactiontype &&
              this.state.interactiontype === 6 && (
                ...
                >
                  ...
                  <StackItem grow>
                    ...
                    <TextField
                      label="Other Interaction Type"
                      value={this.state.otherinteractiontype}
...

              {
                (
                  ...
                  (
                    this.state.interactiontype == 6 &&
                    (
                      this.state.submittoconfluence == undefined ||
                      this.state.submittoconfluence == false
                    )
                  )
                ) &&
                this.getSubmitToConfluenceToggle()
          ...
          >
            ...
            <DefaultButton
              ...
              onClick={() =>
                this.setState({
                  currenttab: NoteTabs.ActionItems
                })
              }
                ...
                <div className="popup-content">
                  ...
                  >
                      ...
                      <Text>
                        <b>Interaction Type: </b>
                        {
                          Interactiontypes.find(
                            i => i.key === this.state.interactiontype
                          )?.text
                        }
                      </Text>
                    </>

                    {
                      ...
                      <>
                        <Text>
                          <b>Other Interaction Type: </b>
                          {this.state.otherinteractiontype}
                        </Text>
                      </>
