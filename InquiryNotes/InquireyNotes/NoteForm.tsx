    ...
    if(this.props.recordid && this.props.recordid !== "") {
      ...
      this.props.context?.webAPI.updateRecord("cr549_inquirynotes", this.props.recordid!, record).then(function(resp){
        ...
        const record = {
          ...
          "cr549_PPInterestForm@odata.bind" : (this.props.context as any).page.entityTypeName == "cr549_ppinterestforms" ? `/cr549_ppinterestformses(${(this.props.context as any).page.entityId})` : null,
          "cr549_PPOnboardingList@odata.bind" : (this.props.context as any).page.entityTypeName == "cr549_pponboardinglist" ? `/cr549_pponboardinglists(${(this.props.context as any).page.entityId})` : null,
          "cr549_ApplicationName@odata.bind": (this.props.context as any).page.entityTypeName == "cr549_application" ? `/cr549_applications(${(this.props.context as any).page.entityId})` : (this.state.application_id != undefined && this.state.application_id != null) ? `/cr549_applications(${this.state.application_id})` : null
        }
