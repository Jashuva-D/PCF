...
import { PowerVaultLogo } from './PowerVaultLogo.tsx';
...
async function renderHomePage() {
  ...
  //else {
    ...
    //   }
      ...
      //   (parent as any).Xrm.Navigation.navigateTo({ pageType: "entitylist", entityName: "pv_notification" });
      // }
      // else if (roles.some((x: any) => x.name == "General Consumer")) {
      //   (parent as any).Xrm.Navigation.navigateTo({ pageType: "entitylist", entityName: "pv_application" });
      // }
      // else {
      //   createRoot(document.getElementById('root')!).render(
      //     <StrictMode>
