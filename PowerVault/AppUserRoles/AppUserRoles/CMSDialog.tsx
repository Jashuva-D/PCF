    ...
    render() {
        return (
            <Dialog
                ...
                dialogContentProps={{
                    title: <div style={{ display: "inline-flex", alignItems: "center"}}><Icon iconName={this.props.iserror == true ? "Error" : "Info"} style={{ color: this.props.iserror == true ? "red" : "#01395E", fontSize: 24, paddingRight: 6}} />{this.props.title} </div>,
            ...
            >   
                <Stack horizontal tokens={{childrenGap: 10}}>
                    <PrimaryButton 
                        ...
                        style={{ borderRadius: 6, backgroundColor: "#01395E" }} 
                    />
                    <DefaultButton 
