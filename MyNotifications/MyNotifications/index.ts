...
export class MyNotifications implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        ...
        // var notifications = context.webAPI.retrieveMultipleRecords("appnotification",`?$filter=_ownerid_value eq '${currentuserid}'`).then(function(resp){
        //     var recs = [];
        ...
        root.render(React.createElement(Notifications, { context: context }));
    }
